                ...
                <div className="p-2">
                    <div>
                        ...
                        <div className="flex items-center justify-between mb-4">
                            <p className=" text-sm flex items-center gap-1 "><span className=" font-bold">Price : </span> <span className="font-bold">{price} BDT</span> </p>
                    ...
                    <div className="flex justify-between mb-4 mt-2 text-center">
                        <p className="font-semibold text-xs flex items-center gap-1 "><span className=" font-bold">Processing Time :</span>{processing_time} Days</p>
                        <p className="font-bold text-xs  flex items-center gap-1 "><span className="">{rating}</span><FaStar className="text-amber-300" /></p>
                    </div>
